...
TAL.sources = {
  ...
  woodland: { id:"woodland", group:"board", name:"The Woodland", short:"Woodland", cls:"s-woodland",
    blurb:"A corner board reached from the Forest space. A linear path to the Meeting With Destiny. Adds Woodland, Path & Destiny decks, the Light/Dark Fate rules, new characters and 3 Alternative Ending Cards." },
  ...
  firelands: { id:"firelands", group:"small", name:"The Firelands", short:"Fire", cls:"s-fire",
    blurb:"Adds new Adventure & Spell cards, Terrain Cards, Trinkets, Fireland tokens (Ifrit hazards) and Noble Ifrit enemies, new characters and 3 Alternative Ending Cards. (No board of its own.)" },
...
TAL.setup = [
  ...
  { ph:1, src:"harbinger", order:25, t:"Prepare the Harbinger & Omen stack",
    d:"Shuffle the Harbinger's Character, Adventure & Spell Cards into the base decks; keep the 75 Harbinger Cards as their own deck (drawn when you share the Harbinger's Region). Place the Harbinger figure on its sheet, then choose one 8-card Omen set and stack it (7th Omen on the bottom … Prophecy on top) next to the sheet.",
  ...
  { ph:1, src:"firelands", order:28, t:"Set up the Firelands cards & tokens",
    d:"Shuffle the Firelands Character, Adventure & Spell Cards into the base decks. Form the Terrain Card deck beside the board and place the Fireland tokens in a supply.",
  ...
  { ph:1, src:"woodland", order:43, t:"Form the Woodland, Path & Destiny decks",
    d:"Shuffle the Woodland deck facedown by the Woodland board. Shuffle the Path deck and draw three Path Cards faceup. Shuffle the Destiny deck and place it facedown. Shuffle the Woodland's new Adventure cards into the base Adventure deck.",
...
TAL.setupCallouts = [
  ...
  { src:"city", t:"Trinkets ignore the carrying limit", when: c => c.has("highland") || c.has("city") || c.has("firelands") || c.has("cataclysm"),
    d:"Objects with the 'Trinket' keyword don't count toward your 4-Object carrying limit. They can still be ditched, stolen, sold or discarded like normal Objects. (Trinkets appear in the Highland, City, Firelands and Cataclysm decks.)" },
  { src:"dragon", t:"The Dragon changes how you win", when: c => c.has("dragon"),
